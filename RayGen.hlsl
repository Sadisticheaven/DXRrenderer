...
void RayGen() {
	...
	// default camera is located at (0,0,1) and looking in the direction (0,0,-1)
	...
	TraceRay(
		...
		// and-ing the mask with a geometry mask. The 0xFF flag then indicate no geometry will 
		// be masked.
		0xFF,
